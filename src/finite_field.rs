...
impl Mul for FiniteField {
    ...
    fn mul(self, other: FiniteField) -> FiniteField {
        if self.value == 2u8 {
            other.by_2()
        } else if self.value == 3u8 {
            other.by_3()
        } else if self.value == 9u8 {
            other.by_9()
        } else if self.value == 11u8 {
            other.by_11()
        } else if self.value == 13u8 {
            other.by_13()
        } else if self.value == 14u8 {
            other.by_14()
        } else {
            panic!("Not implemented for multiplication by {}.", self.value)
        }
    }
}
...
impl FiniteField {
    fn by_2(self) -> FiniteField {
        ...
        FiniteField::new(BY_2[self.value as usize])
    }
    fn by_3(self) -> FiniteField {
        const BY_3: [u8; 256] = [
        ...
        FiniteField::new(BY_3[self.value as usize])
    }
    fn by_9(self) -> FiniteField {
        const BY_9: [u8; 256] = [
        ...
        FiniteField::new(BY_9[self.value as usize])
    }
    fn by_11(self) -> FiniteField {
        const BY_11: [u8; 256] = [
        ...
        FiniteField::new(BY_11[self.value as usize])
    }
    fn by_13(self) -> FiniteField {
        const BY_13: [u8; 256] = [
        ...
        FiniteField::new(BY_13[self.value as usize])
    }
    fn by_14(self) -> FiniteField {
        const BY_14: [u8; 256] = [
        ...
        FiniteField::new(BY_14[self.value as usize])
    }
}
